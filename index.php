...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="//ewizz.net/themes/designr/modern/wp-content/cache/wpfc-minified/c0d86cf9fc9a8877e090ca83085c4432/1507386954index.css" media="all" />
...
<body class="home page-template page-template-template-fullwidth-elementor page-template-template-fullwidth-elementor-php page page-id-880 is-loading elementor-default elementor-page elementor-page-880">
                                ...
                                <div class="elementor-column-wrap elementor-element-populated">
                                    <div class="elementor-widget-wrap">
										...
										<br>
                                            <div class="elementor-widget-container">
												<h2>INTRODUCTION</h2>
												<span class="www_card_small">FIND & FIX DUPLICATE FUNCTIONS</span>
												<span class="www_card_small">OPTIMIZE JS LIBRARIES</span>
												<span class="www_card_small">COLLABORATE AND SHARE at FUNCTION LEVEL</span>
												<span class="www_card_small">CREATE REAL TIME LOGICAL JS LIBRARIES</span>
												<span class="www_card_small">AUTO SCAN TO IMPORT FUNCTIONS TO COCOSPHERE</span>
												<span class="www_card_small">SEARCH COCOSPHERE FOR USERS FUNCTIONS</span>
												<span class="www_card_small">NEVER RE-WRITE FUNCTION MORE THAN ONCE</span>
												<span class="www_card_small">SIGNIFICANTLY TRIM FAT - INCLUDE ONLY WHAT YOU NEED</span>
												...
												<section style="vertical-align:middle;text-align:center;width:100%!Important;max-width:100%;padding:30px;height:300px" data-id="sbndiws" class="www_card" data-settings="{&quot;background_background&quot;:&quot;none&quot;,&quot;shape_divider_top&quot;:&quot;waves&quot;,&quot;shape_divider_bottom&quot;:&quot;waves&quot;}" data-element_type="section">
													<div id="d1" style="width:100%;text-align:center;color:#000">
														<div id="r1">
															<div style="font-family:Open Sans;font-weight:300;font-size:44px">ENTER URL TO SCAN </div>
													...
													<div id="d3" style="display:none;;position:absolute">
														<div style="display:;font-family:Open Sans;font-weight:300;font-size:44px">ENTER URL </div>
														<input style="margin-top:20px;padding:5px;width:350px; height:50.5px;border-radius:8px 0 0 8px;border:0.5px solid silver" type="text" id="uri"><input onclick="remote_script()" type="button" value="import" style="height:50px">
													</div>
                                                                    ...
                                                                    <div class="elementor-widget-container">
                                                                        <div class="elementor-icon-box-wrapper" style="background:">
                                                                            ...
                                                                            <div class="elementor-icon-box-content">
                                                                                <h3 style="font-family:Open Sans;font-weight:300;font-size:24px" class="elementor-icon-box-title"> <span >Enter URL</span></h3>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
												...
												<div id="jsFns" style="font-size:0.7em!Important">
												</div>												<h3>EFFECIENCY</h3>
        ...
        <section id="footer">
            <div class="container footer-flex-center">
                <div class="footer-widget">
                    <div class="textwidget"><img src="http://ewizz.net/themes/designr/modern/wp-content/themes/designr/img/footerlogo.png" alt="" /></div>
                </div>
            </div>
        </section>
    </footer>
...
var ctr=0, mc=0, u='',last_total=0,unique_total=0,duplicates=0
	...
	function remote_script(n) {
		...
		console.log('parseJS.php?uri='+uri+u)
		var request = $.ajax({
